...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes = [
    ...
    { path: '/inventory/compact-wheel-loader/', priority: 0.9, changeFrequency: 'monthly' as const },
    { path: '/inventory/521f/', priority: 0.9, changeFrequency: 'monthly' as const },
    { path: '/inventory/skid-steer/', priority: 0.9, changeFrequency: 'monthly' as const },
    ...
    // { path: '/equipment/521f/', priority: 0.9, changeFrequency: 'monthly' as const },
