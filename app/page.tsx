        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 md:py-40">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl leading-relaxed">
              CASE wheel loaders and skid steers — available year-round. Snow season, spring, summer, fall.
              Large inventory. Long-term rates that make sense.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/quote" className="btn-primary text-sm">
                Get a Quote
              </Link>
              <Link href="/equipment/compact-wheel-loader" className="btn-secondary text-sm">
                View Equipment
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={s.label} className="text-center">
                <div className="text-3xl md:text-4xl font-extrabold text-black">{s.num}</div>
                <div className="text-xs font-bold uppercase tracking-wider text-black/70 mt-1">{s.label}</div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="grid grid-cols-3 gap-3 mb-5">
                  {[
                    ...
                    <div key={s.label} className="text-center bg-gray-50 rounded-lg p-2">
                      <div className="font-extrabold text-gray-900 text-sm">{s.val}</div>
                      <div className="text-xs text-gray-500">{s.label}</div>
                    </div>
                  ))}
                </div>
                <Link href="/equipment/compact-wheel-loader" className="btn-primary w-full text-center text-xs py-2.5">
                  View Specs & Rent
                </Link>
              </div>
            </div>
            ...
            <div className="card group">
              ...
              <div className="p-6">
                ...
                <Link href="/equipment/skid-steer" className="btn-primary w-full text-center text-xs py-2.5">
                  View Specs & Rent
                </Link>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="section-heading mb-4">
                Most Rentals Stop at Winter.<br />
                <span className="text-yellow-500">We Don't.</span>
              </h2>
              <p className="text-gray-600 leading-relaxed mb-6">
                Our fleet doesn't hibernate. Spring, summer, and fall — our equipment is available for
                long-term rentals at rates that beat daily/weekly pricing. Ideal for landscaping, grading,
              ...
              <Link href="/off-season-equipment-rental-kansas-city" className="btn-primary">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="section-subheading mx-auto">
              Direct renters and contractors both get the same great fleet — with options tailored to each.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Direct Renters */}
            ...
            <div className="border-2 border-gray-800 rounded-xl p-8 bg-gray-900 text-white">
              ...
              <p className="text-gray-300 mb-5 leading-relaxed">
                ...
                for fleet access and dedicated contractor pricing.
              </p>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="section-subheading mx-auto">Simple process. Fast turnaround.</p>
          </div>
